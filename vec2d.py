...
class Vec2d(object):
    ...
    def rounded(self):
        return Vec2d(int(self.x + 0.5), int(self.y + 0.5))
    ...
    angle = property(get_angle, setangle, None, "gets or sets the angle of a vector")
    ...
    def get_angle_between(self, other):
        ...
        if dx == 0: # Points on same vertical line
            if dy >= 0:
                return 90.0
            else:
                return -90.0
